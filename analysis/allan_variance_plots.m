...
% Load the gyroscope data from the CSV file
filename = '5hr_data.csv'; % Replace with your actual file name
gyroDataTable = readtable(filename); % Read the data into a table

% If the data is in the first column, extract it
omega = gyroDataTable{:, 8}; % Adjust the index if necessary
